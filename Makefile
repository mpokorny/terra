...
ifeq ($(shell nm $(LLVM_PREFIX)/lib/libLLVMSupport.a | grep setupterm >/dev/null 2>&1; echo $$?), 0)
    SUPPORT_LIBRARY_FLAGS += /home/condor/mpokorny/environments/legms/.spack-env/view/lib/libcurses.so /home/condor/mpokorny/environments/legms/.spack-env/view/lib/libform.so
endif
